...
class Project(models.Model):
	...
	idea = models.TextField(max_length=1000000, default='')
	review=models.TextField(max_length= 1000000, default='')
...
class Course(models.Model):
	...
	project_details = models.TextField(max_length=1000000, default='')
